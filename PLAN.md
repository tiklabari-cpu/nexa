...
| **Faz 2 — v2**     | §5.3 | **📋 PLANLANDI, kod SÜRÜYOR** (plan 2026-08-01; sayım 2026-08-08). Kapsam PRD'ye karşı süpürüldü → **30 kalem**, **sayılarak**: **8 ⬜ açık · 1 ◐ kısmi · 18 ✅ teslim · 3 ⛔ kapsam dışı** (7 faz çelişkisi PRD'den çözüldü). **PLAN'da 12 kalem eksikti** (§D62). Kalan iş **tam atomik** bölündü → §5.2 · `PLAN-V2-KIRILIM.md` · Task Master | v2 `Must` yok — PRD'de v2 kalemlerinin hepsi `Should`/`Could`. §F.00'ın **sayaç** kuralı yerine **kalem** kuralı: **23 açık kalemin hepsi ✅** | ⬜ AÇIK |
...
**8 ⬜ açık · 1 ◐ kısmi · 18 ✅ teslim · 3 ⛔ kapsam dışı** — tablodan **sayılarak** (§1.2: bu sayılar elle yazılmaz; son sayım 2026-08-08, tm 97.1 turunda — `06.3.2-bulk` ⬜→◐ ve önceki turlarda kapanıp sayaca yansımamış bir ✅ dahil edildi).
