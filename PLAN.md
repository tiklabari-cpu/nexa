...
**KAPSAM DIŞI kalan (henüz ⬜):** filtre paneli UI (13.2-h) · `visits_count`+`groups[]` (13.2-i) · 360° panel UI (13.2-j) · uçtan uca doğrulama (13.2-k). Eski not (Faz-0'dan): 03.1.1'in Faz-0'da ertelenen kalan sekmeleri (Supervised/Invited/Browsing) bu kaleme dahil (§3.13 kararı); `visits` şeması **teslim**, tüketicisi bu kalem. → §5.2
