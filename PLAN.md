...
**7 ⬜ açık · 1 ◐ kısmi · 19 ✅ teslim · 3 ⛔ kapsam dışı** — tablodan **sayılarak** (§1.2: bu sayılar elle yazılmaz; son sayım 2026-08-09, tm 98.1 turunda — `05.6` ⬜→◐ (5 alt-görevden ilki `05.6-tmpl31-a` kapandı; kalan 4'ü açık, dilim tamamlanmadı)).
