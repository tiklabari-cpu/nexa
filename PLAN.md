...
| **Faz 2 — v2**     | §5.3 | **📋 PLANLANDI, kod başlamadı** (2026-08-01). Kapsam PRD'ye karşı süpürüldü → **30 kalem**, **sayılarak**: **12 ⬜ açık · 0 ◐ kısmi · 15 ✅ teslim · 3 ⛔ kapsam dışı** (7 faz çelişkisi PRD'den çözüldü). **PLAN'da 12 kalem eksikti** (§D62). Kalan iş **tam atomik** bölündü → §5.2 · `PLAN-V2-KIRILIM.md` · Task Master | v2 `Must` yok — PRD'de v2 kalemlerinin hepsi `Should`/`Could`. §F.00'ın **sayaç** kuralı yerine **kalem** kuralı: **23 açık kalemin hepsi ✅** | ⬜ AÇIK |
...
**12 ⬜ açık · 0 ◐ kısmi · 15 ✅ teslim · 3 ⛔ kapsam dışı** — tablodan **sayılarak** (§1.2: bu sayılar elle yazılmaz).
