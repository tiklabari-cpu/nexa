...
| 09.3 | **API istek paketleri** (Essential/Pro/Pro+) | Could (v2) | | ◐ 09.3-a statik katalog **teslim** — `packages/types/src/api-packages.ts` · test `api-packages.test.ts` (4) · tm 71.1. Kalan: 09.3-b..h (DB tablosu, okuma/satın alma route'ları, fatura satırı, Billing UI, E2E) — Billing **teslim** üzerine (ADR-13 Stripe MOCK — gerçek ödeme yok, kota artışı gerçek). → §5.2 |
