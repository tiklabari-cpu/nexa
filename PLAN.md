...
**8 ⬜ açık · 0 ◐ kısmi · 19 ✅ teslim · 3 ⛔ kapsam dışı** — tablodan **sayılarak** (§1.2: bu sayılar elle yazılmaz; son sayım 2026-08-09, tm 97.8 turunda — `06.3.2-bulk` ◐→✅ (dilimin sekiz alt-görevi de kapandı, uçtan uca doğrulandı); tabloda artık ◐ kalmadı).
