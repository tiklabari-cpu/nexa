...
**KAPSAM DIŞI kalan (henüz ⬜):** uçtan uca doğrulama (13.2-k). Eski not (Faz-0'dan): 03.1.1'in Faz-0'da ertelenen kalan sekmeleri (Supervised/Invited/Browsing) bu kaleme dahil (§3.13 kararı); `visits` şeması **teslim**, tüketicisi bu kalem. → §5.2
