...
export const playbook: Messages = {
  ...
  'playbook.skills.filterAgent': 'Agent',
  'playbook.skills.filterAgentAll': 'All agents',
  'playbook.skills.filterAgentUnassigned': 'Unassigned',
  'playbook.skills.filterAgentUnknown': 'Unknown agent',
  'playbook.skills.filterOwner': 'Owner',
  'playbook.skills.filterOwnerAll': 'All owners',
  'playbook.skills.filterOwnerSystem': 'System',
  'playbook.skills.filterOwnerUnknown': 'Unknown',
  ...
  'playbook.knowledge.formFile': 'File',
  'playbook.knowledge.formFileHelp':
    'Text, Markdown or CSV, up to {size} MiB. Parsed and indexed on save; the file name becomes the title unless you type one.',
  'playbook.knowledge.formFileChosen': 'Ready to upload: {name}',
  'playbook.knowledge.rejectInvalidType': 'Choose a .txt, .md or .csv file.',
  'playbook.knowledge.rejectEmptyFile': 'This file is empty.',
  'playbook.knowledge.rejectTooLarge': 'This file is over the {size} MiB limit.',
  'playbook.knowledge.rejectUnreadable': 'Could not read that file.',
  ...
  'playbook.editor.runLogLoading': 'Loading recent runs…',
  'playbook.editor.runLogError': 'Could not load the run log.',
  'playbook.editor.runLogEmptyTitle': 'This skill has not run yet',
  'playbook.editor.runLogEmptyDescription':
    'Every time the AI agent runs this skill, what it decided will be listed here.',
  'playbook.editor.runLogOpenChat': 'Open the conversation',
  'playbook.editor.runAnswered': 'Answered',
  'playbook.editor.runHandedOff': 'Handed over',
  'playbook.editor.runSkipped': 'Did nothing',
  'playbook.editor.runSucceeded': 'Ran',
  'playbook.editor.runFailed': 'Failed',
  'playbook.editor.runAborted': 'Stopped',
  ...
  'playbook.editor.noSteps': 'No steps yet. Add one below, or write an instruction and compile it.',

  // Step authoring (FR-MOD-06.2.4) — add, delete, retype, and the parameter
  // form each type opens into.
  'playbook.editor.addStep': 'Add step',
  'playbook.editor.addStepType': 'Step type to add',
  'playbook.editor.stepType': 'Step type',
  'playbook.editor.deleteStep': 'Delete step {index}',
  'playbook.editor.noParameters': 'This step takes no settings.',
  'playbook.editor.typeDetectIntent': 'Detect intent',
  'playbook.editor.typeRequestInfo': 'Collect information',
  'playbook.editor.typeTag': 'Add a tag',
  'playbook.editor.typeSummarize': 'Summarise',
  'playbook.editor.typeSendMessage': 'Send a message',
  'playbook.editor.typeTransferToTeam': 'Transfer to a team',
  'playbook.editor.intent': 'Intent',
  'playbook.editor.intentPlaceholder': 'delivery',
  'playbook.editor.phrases': 'Phrases',
  'playbook.editor.phrasesHelp': 'One per line. Leave empty to match on the intent name alone.',
  'playbook.editor.field': 'Information to collect',
  'playbook.editor.fieldPlaceholder': 'order_number',
  'playbook.editor.prompt': 'Question to ask',
  'playbook.editor.promptPlaceholder': 'What is your order number?',
  'playbook.editor.tag': 'Tag',
  'playbook.editor.tagPlaceholder': 'shipping',
  'playbook.editor.replySource': 'Reply with',
  'playbook.editor.sourceText': 'Text you write',
  'playbook.editor.sourceKnowledge': 'An answer from knowledge',
  'playbook.editor.replyText': 'Reply text',
  'playbook.editor.replyTextPlaceholder': 'Thanks — let me check that for you.',
  ...
  'playbook.step.issueSendSource':
    'Choose whether this replies with your own text or from knowledge.',
