...
export const inbox: Messages = {
  ...
  'inbox.composer.richText.bold': 'Kalın',
  'inbox.composer.richText.italic': 'İtalik',
  'inbox.composer.richText.list': 'Madde işaretli liste',
  'inbox.composer.emoji.trigger': 'Emoji ekle',
  'inbox.composer.emoji.category.smileys': 'Yüz ifadeleri',
  'inbox.composer.emoji.category.gestures': 'Jestler',
  'inbox.composer.emoji.category.symbols': 'Simgeler',
  'inbox.composer.tags.trigger': 'Sohbet etiketleri',
  'inbox.composer.tags.empty': 'Henüz önerilecek etiket yok.',
  'inbox.composer.tags.newTagLabel': 'Yeni etiket ekle',
  'inbox.composer.tags.newTagPlaceholder': 'Etiket yazıp Enter’a basın…',
  ...
  'inbox.details.assign.label': 'Atananı değiştir',
  'inbox.details.assign.empty': 'Atanabilecek takım arkadaşı yok.',
  'inbox.details.assign.unavailable': 'Takım listesi kullanılamıyor.',
  'inbox.details.assign.offline': 'Bu takım arkadaşı çevrimdışı.',
