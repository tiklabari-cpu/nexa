...
export const team: Messages = {
  ...
  // Kural botları — RuleBots.tsx (FR-MOD-06.6). Aynı sayfadaki AI ajanın
  // yanında duran, ondan ayrı, deterministik ve LLM'siz sohbet botu.
  'team.ruleBots.title': 'Kural botları',
  'team.ruleBots.description':
    'Yazdığınız kurallardan yanıt veren, yapay zekâ kullanmayan deterministik sohbet botları. Kural botu AI ajandan önce denenir ve yalnızca yanıtladığında ya da devrettiğinde konuşmayı devralır.',
  'team.ruleBots.noAccess.title': 'Kural botlarına erişim yok',
  'team.ruleBots.noAccess.description':
    'Kural botlarını yönetmek AI ajan iznini gerektirir. Bir sahipten bu izni isteyin.',
  'team.ruleBots.loadError': 'Kural botları yüklenemedi. API erişilebilir mi kontrol edin.',
  'team.ruleBots.empty.title': 'Henüz kural botu yok',
  'team.ruleBots.empty.description':
    'Bir bot ekleyin, bir takıma bağlayın, sonra yanıt vereceği kuralları yazın.',
  'team.ruleBots.nameLabel': 'Bot adı',
  'team.ruleBots.nameError': 'Bir ad girin.',
  'team.ruleBots.addBotButton': 'Bot ekle',
  'team.ruleBots.adding': 'Ekleniyor…',
  'team.ruleBots.on': 'Açık',
  'team.ruleBots.off': 'Kapalı',
  'team.ruleBots.enable': 'Aç',
  'team.ruleBots.disable': 'Kapat',
  'team.ruleBots.delete': 'Sil',
  'team.ruleBots.deleteBotAriaLabel': '{name} botunu sil',
  'team.ruleBots.noTeams': 'Henüz bir takıma bağlı değil, bu yüzden kimseye yanıt vermiyor.',
  'team.ruleBots.noRules': 'Henüz kural yok.',
  'team.ruleBots.teamPlaceholder': 'Bir takım seçin…',
  'team.ruleBots.teamAriaLabel': '{name} için takım',
  'team.ruleBots.priorityAriaLabel': '{name} için öncelik',
  'team.ruleBots.attachButton': 'Bağla',
  'team.ruleBots.detachAriaLabel': '{name} botunu {team} takımından ayır',
  'team.ruleBots.ruleNameLabel': 'Kural',
  'team.ruleBots.ruleNameError': 'Kurala bir ad verin.',
  'team.ruleBots.whenLabel': 'Koşul',
  'team.ruleBots.whenValueLabel': 'Eşleşme',
  'team.ruleBots.whenError': 'Neyle eşleşeceğini girin.',
  'team.ruleBots.thenLabel': 'Eylem',
  'team.ruleBots.thenValueLabel': 'Değer',
  'team.ruleBots.thenError': 'Ne yapılacağını girin.',
  'team.ruleBots.addRuleButton': 'Kural ekle',
  'team.ruleBots.enableRuleAriaLabel': '{name} kuralını aç',
  'team.ruleBots.disableRuleAriaLabel': '{name} kuralını kapat',
  'team.ruleBots.deleteRuleAriaLabel': '{name} kuralını sil',
  'team.ruleBots.conditionKindAriaLabel': '{name} için koşul türü',
  'team.ruleBots.actionKindAriaLabel': '{name} için eylem türü',
  'team.ruleBots.condition.message_word': 'Mesajda şu kelime var',
  'team.ruleBots.condition.message_contains': 'Mesaj şunu içeriyor',
  'team.ruleBots.condition.message_equals': 'Mesaj tam olarak şu',
  'team.ruleBots.condition.page_url_contains': 'Sayfa adresi şunu içeriyor',
  'team.ruleBots.action.send_message': 'Şu yanıtı ver',
  'team.ruleBots.action.add_tag': 'Sohbeti etiketle',
  'team.ruleBots.action.transfer_to_group_id': 'Takıma devret',
  'team.ruleBots.describe.message_word': 'mesajda "{value}" kelimesi varsa',
  'team.ruleBots.describe.message_contains': 'mesaj "{value}" içeriyorsa',
  'team.ruleBots.describe.message_equals': 'mesaj tam olarak "{value}" ise',
  'team.ruleBots.describe.page_url_contains': 'sayfa adresi "{value}" içeriyorsa',
  'team.ruleBots.describe.office_hours.open': 'açıkken',
  'team.ruleBots.describe.office_hours.closed': 'kapalıyken',
  'team.ruleBots.describe.send_message': '"{value}" yanıtını ver',
