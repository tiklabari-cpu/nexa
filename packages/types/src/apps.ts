 ...
 * grew the mock catalogue further, to 60+ data apps spread across the same 8
 * categories — there is no upper bound on its size now, only a floor the tests
 * pin. Data apps carry `dataLabel`/`dataFields` (what they show in-chat);
 * channel apps do not (they carry no marketplace connection at all).
 */
